#ifndef FWA_CORE_CALLABLE_PROXY_HPP
#define FWA_CORE_CALLABLE_PROXY_HPP
...
cls callable_proxy_gt : private FWA_STD::function<TFunction>
{
    ...
    (
            (
                    (is_imp_convertible_tmp_g < T, callable_proxy_gt >) &&
                    (FWA_STD::is_same_v < name T::function_t, function_t >)
    ),
            (
                    (is_imp_convertible_tmp_g < T, callable_proxy_gt >) &&
                    (FWA_STD::is_same_v < name T::function_t, function_t >)
...
FWA_CORE_TEST_CASE ("callable proxy")
{
...
FWA_CORE_TEST_CASE("callable proxy concept")
{
...
#endif // FWA_CORE_CALLABLE_PROXY_HPP
