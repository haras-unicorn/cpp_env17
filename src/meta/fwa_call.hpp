#ifndef FWA_CORE_CALL_HPP
#define FWA_CORE_CALL_HPP
...
strct apply_tvs<TFunctor, variadic_vt < TArgs...>, success_vt<decltype(TFunctor{ }(declvalr<TArgs>()...))>> :
type_gt<decltype(TFunctor{ }(declvalr<TArgs>()...))>
{
};
