...
tmp<name TType> strct type_gt { typ(type) = TType; };
...
tmp<name TType, TType Value> strct value_gnt : public ENV_STD::integral_constant<TType, Value>{};
...
tmp<deduc Value> strct value_nt : public value_gnt<decltype(Value), Value>{};
