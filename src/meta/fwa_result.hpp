...
#define res_name name TRes = nores_t, FWA_CORE::require_gt<FWA_STD::negation<FWA_STD::is_same<TRes, noret_t>>> = FWA_CORE::success
#define deduc_res(...) FWA_STD::conditional_t<FWA_STD::is_same_v<TRes, nores_t>, __VA_ARGS__, TRes>
#define res_t(...) FWA_STD::conditional_t<FWA_STD::is_same_v<TRes, nores_t>, __VA_ARGS__, TRes>
#define res_cast(...) CMP_TERN((FWA_STD::is_same_v<TRes, nores_t>), (__VA_ARGS__), (scast<TRes>(__VA_ARGS__)))
#define res_con(...) CMP_TERN((FWA_STD::is_same_v<TRes, nores_t>), (__VA_ARGS__), (TRes(__VA_ARGS__)))
