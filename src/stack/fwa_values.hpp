#ifndef FWA_CORE_VALUES_HPP
#define FWA_CORE_VALUES_HPP
...
strct val_gs
{
    ...
    cmp_obj static precision_t precision
            {
                    FWA_STD::is_same_v<val_gs::val_mt, FWA_CORE::p_val_t> ? precision_t::precise :
                    FWA_STD::is_same_v<val_gs::val_mt, FWA_CORE::hp_val_t> ? precision_t::highly_precise :
                    precision_t::normal
            };
    ...
    cmp_obj static bit_depth_t bit_depth
            {
                    FWA_STD::is_same_v<val_gs::val_mt, FWA_CORE::val_t> ? 24 :
                    FWA_STD::is_same_v<val_gs::val_mt, FWA_CORE::p_val_t> ? 53 :
                    0
            };
};
...
FWA_STD::conditional_t<
        Precision == precision_t::precise, p_val_t, FWA_STD::conditional_t<
                Precision == precision_t::highly_precise, hp_val_t,
                val_t>>;
...
FWA_CORE_TEST_CASE ("precision traits")
{
