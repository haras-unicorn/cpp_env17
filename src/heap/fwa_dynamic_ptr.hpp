#ifndef FWA_CORE_DYNAMIC_PTR_HPP
#define FWA_CORE_DYNAMIC_PTR_HPP
...
strct dynamic_data_gt<TPtr, TAlloc, FWA_CORE::require_nt<FWA_STD::is_empty_v<TAlloc> && !FWA_STD::is_final_v<TAlloc>>> :
        protected TAlloc
{
    typ(ptr_t) = TPtr;
...
#endif // FWA_CORE_DYNAMIC_PTR_HPP
