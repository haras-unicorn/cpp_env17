#ifndef FWA_CORE_PTR_HPP
#define FWA_CORE_PTR_HPP
...
FWA_CORE_TEST_CASE ("unranked ptr")
{
    obj int a = 1;
    obj ptr_cgt<int> b = &a;
    REQUIRE_EQ(*b, a);
