...
EXPR_CHECK_TERNARY(
        test_addable_ternary,
        declvalr<T1>() + declvalr<T2>() + declvalr<T3>());

#if ENV_CPP >= 17 // fold expression

EXPR_CHECK_VARIADIC(
        test_addable_variadic,
        sum_res(declvalr<TVar>()...));
...
ENV_TEST_CASE("expr check")
{
    ...
    SUBCASE("variadic")
    {
        REQUIRES(test::test_addable_variadic_g<
                 var_vt<int, int, int, int>>);
        REQUIRES_FALSE(test::test_addable_variadic_g<
                       var_vt<int, void, int>>);
    }
#endif // ENV_CPP >= 17
}
...
ENV_TEST_CASE("expr check class")
{
    ...
    SUBCASE("binary")
    {
        REQUIRES(test::expr_check_class_t::test_addable_binary_g<
                 int, int>);
        REQUIRES_FALSE(test::expr_check_class_t::test_addable_binary_g<
                       int, void>);
    }

    SUBCASE("ternary")
    {
        REQUIRES(test::expr_check_class_t::test_addable_ternary_g<
                 int, int, int>);
        REQUIRES_FALSE(test::expr_check_class_t::test_addable_ternary_g<
                       int, void, int>);
    }
    ...
    SUBCASE("variadic")
    {
        REQUIRES(test::expr_check_class_t::test_addable_variadic_g<
                 var_vt<int, int, int, int>>);
        REQUIRES_FALSE(test::expr_check_class_t::test_addable_variadic_g<
                       var_vt<int, void, int>>);
    }
...
COND_CHECK_BINARY(
        test_const_binary,
        ENV_STD::is_const<TLhs>,
        ENV_STD::is_const<TRhs>);
...
ENV_TEST_CASE("cond check")
{
    ...
    SUBCASE("variadic")
    {
        REQUIRES(test::test_const_variadic_g<
                 var_vt<const int, const int, const int, const int>>);
        REQUIRES_FALSE(test::test_const_variadic_g<
                       var_vt<int, void, const int>>);
    }
}
...
ENV_TEST_CASE("cond check class")
{
    ...
    SUBCASE("binary")
    {
        REQUIRES(test::cond_check_class_t::test_const_binary_g<
                 const int, const int>);
        REQUIRES_FALSE(test::cond_check_class_t::test_const_binary_g<
                       int, void>);
    }

    SUBCASE("ternary")
    {
        REQUIRES(test::cond_check_class_t::test_const_ternary_g<
                 const int, const int, const int>);
        REQUIRES_FALSE(test::cond_check_class_t::test_const_ternary_g<
                       int, void, const int>);
    }

    SUBCASE("variadic")
    {
        REQUIRES(test::cond_check_class_t::test_const_variadic_g<
                 var_vt<const int, const int>>);
        REQUIRES_FALSE(test::cond_check_class_t::test_const_variadic_g<
                       var_vt<int, void, const int>>);
    }
}
...
ENV_TEST_CASE("type check")
{
    ...
    SUBCASE("variadic")
    {
        REQUIRES(test::test_minus_variadic_g<
                 var_vt<const int, const int, const int, const int>>);
        REQUIRES_FALSE(test::test_minus_variadic_g<
                       var_vt<int, void, const int>>);
    }
}
...
ENV_TEST_CASE("type check class")
{
    ...
    SUBCASE("binary")
    {
        REQUIRES(test::type_check_class_t::test_minus_binary_g<
                 const int, const int>);
        REQUIRES_FALSE(test::type_check_class_t::test_minus_binary_g<
                       int, void>);
    }

    SUBCASE("ternary")
    {
        REQUIRES(test::type_check_class_t::test_minus_ternary_g<
                 const int, const int, const int>);
        REQUIRES_FALSE(test::type_check_class_t::test_minus_ternary_g<
                       int, void, const int>);
    }

    SUBCASE("variadic")
    {
        REQUIRES(test::type_check_class_t::test_minus_variadic_g<
                 var_vt<const int, const int>>);
        REQUIRES_FALSE(test::type_check_class_t::test_minus_variadic_g<
                       var_vt<int, void, const int>>);
    }
}
