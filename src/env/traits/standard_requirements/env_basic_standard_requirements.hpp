...
// eligible for memcpy
COND_CHECK_UNARY(is_std_trivially_copyable, ENV_STD::is_trivially_copyable_v<T>);
...
COND_CHECK_UNARY(is_std_trivial, ENV_STD::is_trivial_v<T>);
...
COND_CHECK_UNARY(is_std_standard_layout, ENV_STD::is_standard_layout_v<T>);
...
// a C struct
COND_CHECK_UNARY(is_std_pod, ENV_STD::is_pod_v<T>);
...
EXPR_CHECK_UNARY(is_std_swappable, ENV_STD::swap(declvall<T>(), declvall<T>()));
