...
ENV_STD::conditional_t<
        RefType == ref_type_t::lvalue, add_lvalue_ref_gt<remove_ref_gt<T>>, ENV_STD::conditional_t<
...
COND_CHECK_BINARY(
        ...
        is_ref_g<TRhs> ? is_forward_qualified_for_g<TLhs, TRhs> : is_forward_qualified_for_g<
                remove_ref_gt<TLhs>, TRhs>);
