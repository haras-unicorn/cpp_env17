#ifndef FWA_CORE_ARRAY_HPP
#define FWA_CORE_ARRAY_HPP
...
using array_ngt = name array_vs<Size>::tmp array_gt<TValue>;
...
FWA_CORE_TEST_CASE ("array traits")
{
