#ifndef FWA_CORE_CONTAINER_TRAITS_REQUIREMENTS_HPP
#define FWA_CORE_CONTAINER_TRAITS_REQUIREMENTS_HPP
...
strct container_traits_gt
{
    ...
    sass(FWA_STD::is_same_v<ref_t, value_t&>);
    sass(FWA_STD::is_same_v<c_ref_t, const value_t&>);

    sass(FWA_STD::is_same_v<name FWA_STD::iterator_traits<iterator_t>::difference_type, difference_t>);
    sass(FWA_STD::is_same_v<name FWA_STD::iterator_traits<c_iterator_t>::difference_type, difference_t>);
    ...
    sass(FWA_STD::is_convertible_v<iterator_t, c_iterator_t>);
};
...
public:
    ...
    sass(FWA_STD::is_same_v<FWA_STD::reverse_iterator<iterator_t>, reverse_iterator_t>);
    sass(FWA_STD::is_same_v<FWA_STD::reverse_iterator<c_iterator_t>, c_reverse_iterator_t>);
};
...
(
        ...
        T(declval<FWA_STD::initializer_list<name container_traits_gt<T>::value_t>>())
);
...
(
        ...
        FWA_STD::is_same_v<decl(
                declvalr<T>().insert(
                        declval<name container_traits_gt<T>::c_iterator_t>(),
                        declval<FWA_STD::initializer_list<name container_traits_gt<T>::value_t>>())),
        name container_traits_gt<T>::iterator_t>
);
...
(
        ...
        FWA_STD::is_same_v<decl(declvall<T>() = declvall<const T>()), T&>
);
...
(
        ...
        FWA_STD::is_same_v<
                decl(declvalr<T>() = declval<FWA_STD::initializer_list<name container_traits_gt<T>::value_t>>()),
                T&>
);
...
(
        ...
        T(declval<FWA_STD::initializer_list<name unordered_associative_container_traits_gt<T>::value_t>>(),
          declval<name unordered_associative_container_traits_gt<T>::size_t>(),
          declval<name unordered_associative_container_traits_gt<T>::hasher_t>(),
          declval<name unordered_associative_container_traits_gt<T>::key_equal_t>())
);
...
#endif // FWA_CORE_CONTAINER_TRAITS_REQUIREMENTS_HPP
