#ifndef FWA_CORE_OTHER_REQUIREMENTS_HPP
#define FWA_CORE_OTHER_REQUIREMENTS_HPP
...
(
        is_std_numeric_type,
        !FWA_STD::is_const_v < T > && !FWA_STD::is_volatile_v < T > &&
...
#endif // FWA_CORE_OTHER_REQUIREMENTS_HPP
