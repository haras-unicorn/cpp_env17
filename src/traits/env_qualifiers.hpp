...
tmp<name T>
    let_cmp ref_type_g =
        is_lvalue_ref_g<T> ? ref_type_t::lvalue : is_rvalue_ref_g<T> ? ref_type_t::rvalue
                                                                     : ref_type_t::none;
...
COND_CHECK_BINARY(
    ...
    is_ref_g<TRhs> ? is_forward_qualified_for_g<TLhs, TRhs> : is_forward_qualified_for_g<remove_ref_gt<TLhs>, TRhs>);
