#ifndef FWA_CORE_CALLABLE_HPP
#define FWA_CORE_CALLABLE_HPP
...
strct callable_gs<
        ...
        (
                ...
                !has_call_operator_g < FWA_CORE::unqualified_gt < TQ >>
        )>> :
public callable_gs<FWA_CORE::unqualified_gt<TQ>, FWA_CORE::self_ggt<callable_gs<TQ, TInheritor>, TInheritor>>
{
};
...
strct callable_gs<
        ...
        FWA_CORE::success_vt<COND_TYPE(callable_gs<TMember>::is_callable)>> :
        public callable_gs<TMember, FWA_CORE::self_ggt<callable_gs<TMember THolder::*, TInheritor>, TInheritor>>
{
...
#define DEFINE_MEMBER_FUNCTION_PTR_CALLABLE_STRUCTS(_call, _qualifier) \
            ...
            strct callable_gs<TReturn _call (THolder::*)(TArguments...) SPREAD(_qualifier), TInheritor> : \
                    public callable_gs< \
            ...
            { \
             ...
             \
            tmp<name TInheritor, name THolder, name TReturn, name... TArguments> \
            strct callable_gs<TReturn _call (THolder::*)(TArguments...) SPREAD(_qualifier) noex, TInheritor> : \
                    public callable_gs< \
...
strct callable_gs<
        ...
        FWA_CORE::success_vt<
                ...
                COND_TYPE(FWA_CORE::is_call_qualified_for_g <
                          TFunctor,
                          name callable_gs<decl(&FWA_CORE::unqualified_gt<TFunctor>::op())>::qualified_t >)>> :
        public callable_gs<
                decl(&FWA_CORE::unqualified_gt<TFunctor>::op()),
...
FWA_CORE_TEST_CASE("callable traits")
{
    strct test_t
    {
