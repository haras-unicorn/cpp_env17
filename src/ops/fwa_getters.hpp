#ifndef FWA_CORE_GETTERS_HPP
#define FWA_CORE_GETTERS_HPP
...
#define DEF_NIL_MEM(_type, _name) DECL_MEM(_name) { FWA_CORE::nil }
...
FWA_CORE_TEST_CASE ("member getters")
{
...
FWA_CORE_TEST_CASE("singleton getters")
{
    SUBCASE("singleton")
    {
