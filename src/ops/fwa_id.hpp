#ifndef FWA_CORE_ID_HPP
#define FWA_CORE_ID_HPP
...
FWA_CORE_TEST_CASE("identifiable")
{
    strct { cmp_fn id() const noex { ret 1_id; } } test{ };
...
FWA_CORE_TEST_CASE ("id operations")
{
